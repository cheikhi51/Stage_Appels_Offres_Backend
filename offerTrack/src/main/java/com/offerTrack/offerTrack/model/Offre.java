...
public class Offre {
    ...
    private String statut_admin;
    private String statut_tech;
    ...
    public Offre(int id_offre, int id_maitre_ouvrage, String reference_num, String objet, String lieu, LocalDateTime date_limite, int num_ordre, String statut_admin, String statut_tech, String statut_financier, String publication_portail, String informations_additionnelles) {
    ...
    public String getStatut_admin() {
        return statut_admin;
    }

    public void setStatut_admin(String statut_admin) {
        this.statut_admin = statut_admin;
    }

    public String getStatut_tech() {
        return statut_tech;
    }

    public void setStatut_tech(String statut_tech) {
        this.statut_tech = statut_tech;
    }
